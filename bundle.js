...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoContainer = __webpack_require__(168);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Footer2.default, { items: 'xx' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todos = __webpack_require__(195);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      { onSubmit: function onSubmit(e) {
	          ...
	          dispatch((0, _todos.addTodo)(input.value));
	          input.value = '';
	        } },
	      _react2.default.createElement('input', { className: 'new-todo', placeholder: 'What needs to be done?', ref: function ref(node) {
	          input = node;
	        } })
	    )
	  );
	};
	TodoContainer = (0, _reactRedux.connect)()(TodoContainer);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onTodoClick: function onTodoClick(id) {
	      dispatch((0, _todos.toggleTodo)(id));
	    }
	  };
	};

	// map state to props to use in TodoList component
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todos = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RemainingItem = __webpack_require__(205);

	var _RemainingItem2 = _interopRequireDefault(_RemainingItem);
	...
	var Footer = function Footer() {
	  return _react2.default.createElement(
	    'footer',
	    { className: 'footer' },
	    _react2.default.createElement(_RemainingItem2.default, null),
	    _react2.default.createElement(
	      'ul',
	      { className: 'filters' },
	      _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onClick: function onClick() {
	      dispatch((0, _todos.setFilter)(ownProps.filter));
	    }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return {
	    remaining: state.todos.reduce(function (count, todo) {
	...
	var RemainingItem = function RemainingItem(_ref) {
	...
	RemainingItem = (0, _reactRedux.connect)(mapStateToProps)(RemainingItem);

		exports.default = RemainingItem;
